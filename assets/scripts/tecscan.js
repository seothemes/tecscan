( function( document, $, undefined ) {
	 ...
	 */
	var frontPageFourVideo  = $( '.front-page-4 .wp-video' );
	var frontPageFourIframe = $( '.front-page-4 iframe' );

	frontPageFourVideo.append( '<button class="hide-video">×</button>' );
	frontPageFourVideo.prepend( '<div class="before"></div>' );
